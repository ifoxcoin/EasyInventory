	...
	public class frmReceipt : Form
	{
		...
		private void cbocustomer_Leave(object sender, EventArgs e)
		{
			...
			using (inventoryDataContext)
			{
                ...
                IQueryable<openingbalance> openingbalancedata = inventoryDataContext.openingbalances.Where((openingbalance list) => list.led_id == (long?)(long)Convert.ToInt32(cbocustomer.SelectedValue) && list.ob_isclose == (bool?)false);
