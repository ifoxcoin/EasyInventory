    ...
    public class frmPayment : Form
    {
        ...
        private void cboSupplier_Leave(object sender, EventArgs e)
        {
            ...
            using (inventoryDataContext)
            {
                ...
                IQueryable<openingbalance> openingbalancedata = inventoryDataContext.openingbalances.Where((openingbalance list) => list.led_id == (long?)(long)Convert.ToInt32(cboSupplier.SelectedValue) && list.ob_isclose == (bool?)false);
        ...
        private void InitializeComponent()
        {
            ...
            this.lblsubtitle.Size = new System.Drawing.Size(143, 23);
